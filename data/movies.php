...
$batman_v_superman = new Movies ('Batman v Superman, dawn of justice', $snyder, $cast, '181 min', $batman_line, '874362803');

$justice_league = new Movies ('Zack Snyder \'s Justice League', $snyder, $cast, '242 min', $batman_line_j);
